...
const Login = () => {
  ...
  return (
    <div>
      <Header />
      <div className="flex items-center justify-center mt-4 mb-28">
        <div className="w-full  max-w-lg">
          <div className="flex  justify-center items-center mb-6">
            <div className=" flex   items-center flex-shrink-0 text-blue mr-16">
              <span className="font-bold text-blue-900 p-3 text-2xl capitalize   flex justify-center items-center gap-2">
